...
SECRET_KEY = 'django-insecure-m)8zg12@0&ocj9ppvcqz(^)*%l25)ux64704ej4wipx94-q%d^'
...
CSRF_COOKIE_HTTPONLY = False  # Needed for frontend to handle CSRF (we'll improve later)
